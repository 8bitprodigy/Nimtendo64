...
proc exec(input, output: pointer) {.importc: "joybus_exec", header: "libdragon/joybus.h".}

proc exec_cmd(port: cint, send_len, recv_len: csize_t, send_data: pointer, recv_data: pointer) {.importc: "joybus_exec_cmd", header: "libdragon/joybus.h".}
